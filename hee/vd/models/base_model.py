...
from vd.models import lr_scheduler as lr_scheduler
from vd.utils import get_root_logger, master_only
...
class BaseModel():
    ...
    def _initialize_best_metric_results(self, dataset_name):
        ...
        for metric, content in self.opt['val']['metrics'].items():
            ...
            record['SSIM_l1'] = dict(better='higher', val=float('-inf'), iter=-1)
            record['PSNR_l1'] = dict(better='higher', val=float('-inf'), iter=-1)
